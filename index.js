...
const stepThroughCell = (row, column) => {
    ...
    // Assemble ranndomly-ordered list of neighbors
    ...
    for (let neighbor of neighbors) {
        ...
        // See of that neighbor is out of bounds
...
horizontals.forEach((row, rowIndex) => {
    row.forEach((open, columnIndex) => {
        ...
        const wall = Bodies.rectangle(
            ...
            unitLengthX,
            10, {isStatic:true, label:'wall', render:{fillStyle:'orange'}}
        );
...
verticals.forEach((row, rowIndex) => {
    row.forEach((open, columnIndex) => {
        ...
        const wall = Bodies.rectangle(
            ...
            10,
            unitLengthY,
            {isStatic:true, label:'wall', render:{fillStyle:'orange'}}
        );
        World.add(world, wall);
    });
});
...
const ball = Bodies.circle(
    ...
    unitLengthY / 2,
    ballRadius,
    {label: 'ball', render:{fillStyle:'aqua'}}
);
